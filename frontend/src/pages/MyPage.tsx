...
import { getMyProfile, updateMyProfile, changePassword, uploadProfilePhoto, getFollowers, getFollowing } from '../api/user'
import { updateArtworkTitle, toggleArtworkVisibility, deleteArtwork, getMyArtworks } from '../api/artwork'
import type { UserProfile } from '../api/user'
import type { ArtworkSummary } from '../api/artwork'
